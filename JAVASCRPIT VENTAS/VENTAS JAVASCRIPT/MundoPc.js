...
let monitor1 = new Monitor('Samsung', '20pulgadas');
let monitor2 = new Monitor('Lenovo', '25pulgadas');
//console.log(monitor1.toString());
//console.log(monitor2.toString());

let computadora1 = new Computadora('Mac', monitor1, raton1, teclado1);
let computadora2 = new Computadora('DELL', monitor2, raton2, teclado2);
let computadora3 = new Computadora('HP', monitor1, raton2, teclado1);
let computadora4 = new Computadora('Razer', monitor2, raton1, teclado2);
